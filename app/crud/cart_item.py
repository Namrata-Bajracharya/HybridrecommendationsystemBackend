...
class CartCrud:
    ...
    def get_cart_item_by_product(self, cart_id: int, product_id: int, variant_id: int | None = None):
    ...
    def update_existing_cart_item(
        self, cart_id: int, product_id: int, variant_id: int | None, quantity: int
    ) -> CartItem:
        stmt = (
            update(CartItem)
            .where(
    ...
    def add_new_cart_item(
        self, cart_id: int, product_id: int, quantity: int, variant_id: int | None = None
    ) -> CartItem:
        new_item = CartItem(
